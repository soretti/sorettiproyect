<div class="relative promociones-lateral">
<div class="barra-azul text-left ">Promociones</div>
        <?php  if($this->acceso->valida('catalogo','editar')) { ?>
        <i class="tip-tools"></i>
        <div id="user-options">
            <a href="<?php echo base_url('modulo/catalogo/catalogodestacados/editar/promociones'); ?>" class="editar"><span class="glyphicon glyphicon-edit"></span></a>
        </div>
        <div class="editable"><div class="zona-editable"></div></div>
        <?php } ?>
        <div class="box">
                <div class="lista-productos lateral">
                    ...
                    $imagen=(isset($portadas[$destacado->producto_id])) ? name_image($portadas[$destacado->producto_id],'catalogo','cat_imagen',$imagenes->lista_w,$imagenes->lista_h) : 'thumb-default.jpg'; ?>
                        <div class="item">
                            ...
                            <div class="titulo-producto text-center">
                                <a href="<?php echo url_idioma(base_url('catalogo/'.$destacado->producto_cat_categoria_uri."/".$destacado->producto_uri.".html")); ?>">
                                    <h5><?php echo  ucfirst(strtolower (character_limiter($destacado->{'producto_titulo'.IDIOMA}, 90))); ?></h5>
                                </a>
                            </div>
