  ...
  <div class="col-md-12 form-inline">
    <div class="controls">
      ...
      <div class="input-group">
        <select class="control-catalogo form-control"  name="" id="" onChange="document.location='<?php echo url_idioma(site_url('catalogo/marca/'.$marca->uri)); ?>?orden='+this.value">
        ...
        <span class="input-group-btn">
          <a class="btn btn-default" href="<?php echo site_url('catalogo/marca/'.$marca->uri) ?>?direction=<?php echo $direction['direction'] ?>" role="button"><i class="fa fa-angle-<?php echo $direction['icon'] ?>"></i></a>
        </span>
      </div>
      <span class="trLabel"><?php echo $this->lang->line('mostrar') ?> </span>
      <select  class="control-catalogo form-control" name="" id="" onChange="document.location='<?php echo url_idioma(site_url('catalogo/marca/'.$marca->uri)); ?>?per_page='+this.value ">
      ...
      <span class="trLabel">
        ...
        <input type="checkbox" name="" id="" <?php if($this->wstock=='true') echo "checked"; ?> onClick="document.location='<?php echo url_idioma(site_url('catalogo/marca/'.$marca->uri)); ?>?wstock='+$(this).is(':checked')" > </span>
    </div>
  </div>
</div>
