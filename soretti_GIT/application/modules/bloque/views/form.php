    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="btn-toolbar">
                ...
                <a class="btn btn-primary" href="<?php echo base_url('modulo/'.$this->uri->segment(2).'/agregar_bloque/'.$bloque->id) ?>">Agregar</a>
                <?php } ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="titulo_en" value="<?php echo $bloque->titulo_en; ?>"  class="form-control">
                <?php echo $bloque->error->titulo ?>
            </div>
