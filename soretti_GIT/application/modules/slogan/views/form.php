    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="btn-toolbar">
                ...
                <button class="btn btn-primary" type="submit" onclick="goto('<?php echo base_url('modulo/slogan/guardar_bloque/'.$bloque->id.'/'.$bloques->id) ?>')">Guardar</button>
                <?php } ?>
                <a class="btn btn-default" href="<?php echo base_url('modulo/slogan/editar/'.$bloque->id) ?>">Regresar</a>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="tab-pane active" id="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" value="<?php echo $bloques->imagen ?>" modulo="bloqueImagen" name="imagen" width="<?php echo $bloques->img_width ?>" height="<?php echo $bloques->img_height ?>">
