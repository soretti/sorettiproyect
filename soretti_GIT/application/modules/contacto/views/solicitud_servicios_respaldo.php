                    ...
                    <div class="form-group">
                        ...
                        <h5>Detalle de la especialidad</h5>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="form-lugar_trabajo"  class="form-control input-sm" name="lugar_trabajo" value="<?php echo $this->input->post('lugar_trabajo'); ?>" placeholder="Lugar de trabajo donde se asignará el profesional: * "/>
                           ...
                           <!--  <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control input-sm" name="tareas" id="" placeholder="Tareas / funciones a realizar por el profesional: * "><?php echo $this->input->post('tareas'); ?></textarea>
