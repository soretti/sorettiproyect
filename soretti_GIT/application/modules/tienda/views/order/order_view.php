				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<?php if($factura->rfc): ?>
							...
							<div class="txt-direccion" >Razón social: <?php echo $factura->razon_social ?></div>
						...
						<div class="cuadro wrapper">
							<table class="pull-right total-compra">
								...
								<tr>
									...
									<td class="text-right importe"><?php echo "- ".formato_precio($pago->descuentoCupon) ?></td>
								</tr>
								<?php } ?>
								<?php if($pago->descuentoMayoreo) {?>
								<tr>
									<td class="text-left">Descuento: </td>
									<td class="text-right importe"><?php echo "- ".formato_precio($pago->descuentoMayoreo) ?></td>
								</tr>
								<?php } ?>
								<tr>
									<td class="text-left">
