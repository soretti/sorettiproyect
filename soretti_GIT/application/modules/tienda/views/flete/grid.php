<form action="" method="post" id="myform">
  ...
  <div class="row">
      <div class="col-md-8">
        ...
        <a class="btn btn-primary"  href="<?php echo base_url('modulo/tienda/flete/agregar/') ?>"><i class="glyphicon glyphicon-plus icon-white"></i> Agregar</a>
        <?php } ?>
        <?php if($this->acceso->valida('fletes','eliminar')) {?>
        <a class="btn btn-danger seleccionados" href="<?php echo base_url('modulo/tienda/flete/eliminar') ?>" ><i class="glyphicon glyphicon-trash icon-white"></i> Eliminar seleccionados</a>
        <?php } ?>
      </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td nowrap>
                  ...
                  <?php if($this->acceso->valida('fletes','consultar')) {?>
                  <a href="<?php echo base_url('modulo/tienda/flete/editar/'.$marca->id); ?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-edit"></i></a>
                  <?php } ?>
                  <?php if($this->acceso->valida('fletes','eliminar')) {?>
                  <button class="btn btn-danger btn-sm  action_row" value="basura" type="button" href="<?php echo base_url('modulo/tienda/flete/eliminar/'); ?> " ><i class="glyphicon glyphicon-trash"></i></button>
                  <?php } ?>
                </td>
              </tr>
              <?php } ?>
