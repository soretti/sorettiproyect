<div class="relative">
    ...
    <i class="tip-tools"></i>
    <div id="user-options">
        <a href="<?php echo base_url('modulo/blog/blogcategorias/listar/'.$pagina->id); ?>" class="editar"><span class="glyphicon glyphicon-edit"></span></a>
    </div>
    ...
    <div class="modulo menu-categorias-vertical">
        <div id='cssmenu'>
            ...
            ?>
                ...
                <li> <a href="<?php echo url_idioma(base_url('blog/'.$pagina->uri."/categoria/".$categoria->uri.".html")); ?>"> <?php echo $categoria->{'titulo'.IDIOMA} ?> (<?php echo $total_x_categoria; ?>) </a>  </li>
                <?php } ?>
                <?php } ?>
            </ul>
        </div>
