  <?php $urlstring=(uri_string()) ? uri_string() : 'paginas/servicios';
...
<div class="relative table">
    ...
    <i class="tip-tools"></i>
    <div id="user-options">
        <a href="<?php echo base_url('modulo/slider/editar/'.$bloques->id.'/'. $urlpage[1] ); ?>" class="editar"><span class="glyphicon glyphicon-edit"></span></a>
    </div>
