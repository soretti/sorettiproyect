    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="btn-toolbar">
                ...
                <button class="btn btn-primary" type="submit" onclick="goto('<?php echo base_url('modulo/atributos/guardar_bloque/'.$bloque->id.'/'.$bloques->id) ?>')">Guardar</button>
                <?php } ?>
                <a class="btn btn-default" href="<?php echo base_url('modulo/atributos/editar/'.$bloque->id) ?>">Regresar</a>
            </div>
        </div>
    </div>
    <div class="row">
