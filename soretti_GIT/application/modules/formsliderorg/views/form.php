                ...
                <div class="col-md-12">
                    ...
                    <div class="btn-toolbar">
                        <?php if($this->acceso->valida('pagina','editar')) {?>
                            <button class="btn btn-success" type="submit" onclick="goto('<?php echo base_url('modulo/formsliderorg/guardar_bloque/'.$bloque->id.'/'.$bloques->id) ?>')">Guardar</button>
                        <?php } ?>
                        <a class="btn btn-default" href="<?php echo base_url('modulo/formsliderorg/editar/'.$bloque->id) ?>">Regresar</a>
                    </div>
                    ...
                    <!-- <div class="col-md-6">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="titulo_imagen" value="<?php echo $bloques->titulo_imagen; ?>" class="form-control">
