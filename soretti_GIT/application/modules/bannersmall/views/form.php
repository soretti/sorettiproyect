                ...
                <div class="col-md-12">
                    ...
                    <div class="btn-toolbar">
                        <?php if($this->acceso->valida('bloque','editar')) {?>
                            <button class="btn btn-success" type="submit" onclick="goto('<?php echo base_url('modulo/bannersmall/guardar_bloque/'.$bloque->id.'/'.$bloques->id) ?>')">Guardar</button>
                        <?php } ?>
                        <a class="btn btn-default" href="<?php echo base_url('modulo/bannersmall/editar/'.$bloque->id) ?>">Regresar</a>
                    </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <!-- <div class="col-md-6">
                        ...
                        <div class="checkbox">
                        <label>
                          <input name="visible" type="checkbox" value="1" <?php //echo($bloques->visible==1) ? 'checked' : 'unchecked'; ?> > Mostrar título en bannersmall
                        </label>
                      </div>
...
<!-- 
 ...
 -->
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="titulo_imagen" value="<?php echo $bloques->titulo_imagen ?>" id="titulo_imagen" class="form-control">
                          <?php echo $bloques->error->titulo_imagen; ?>
                      </div>
                         <div class="form-group ">
