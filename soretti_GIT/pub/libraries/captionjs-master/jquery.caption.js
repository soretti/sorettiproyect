...
(function($, window, undefined){
	$.fn.captionjs = function(opts){
		...
		return this.each(function(){
			...
			alt=$(this).attr('alt');
			if($(this).attr('creditos')!='' && $(this).attr('creditos')!=undefined)
				alt=alt+' ('+$(this).attr('creditos')+')';
			if(alt) alt='<div class="txtcaption"><span></span>'+alt+'</div>';

			var $this       = $(this),  // The image
			    $caption    = $this.data('caption') ? $this.data('caption') : alt,
			...
			style_image=$this.attr('style');
			style_figure=$figure.attr('style');

			$figure.attr('style',style_figure+' '+style_image);
